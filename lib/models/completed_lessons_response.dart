...
//
//     final completedLessonsResponse = completedLessonsResponseFromJson(jsonString);

import 'dart:convert';

List<CompletedLessonsResponse> completedLessonsResponseFromJson(String str) =>
    List<CompletedLessonsResponse>.from(
        json.decode(str).map((x) => CompletedLessonsResponse.fromJson(x)));

String completedLessonsResponseToJson(List<CompletedLessonsResponse> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class CompletedLessonsResponse {
  ...
  factory CompletedLessonsResponse.fromJson(Map<String, dynamic> json) =>
      CompletedLessonsResponse(
